	...
	return (
		<Pressable onPress={onPress} style={[{ width: size, height: size }, style]} {...properties}>
			<Svg width={size} height={size} viewBox="0 0 32 32" fill="none" style={{ overflow: 'visible' }}>
				...
				<Line x1="6" y1="26" x2="26" y2="6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
				<Line x1="6" y1="6" x2="26" y2="26" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
			</Svg>
		</Pressable>
	);
}
