...
function ArrowLeftIcon({ size = 32, color = '#000000', style, onPress, ...properties }: types.Parameters): types.Component {
	...
	return (
		<Pressable onPress={onPress} style={[{ width: size, height: size }, style]} {...properties}>
			<Svg width={size} height={size} viewBox="0 0 32 32" fill="none" style={{ overflow: 'visible' }}>
				...
				<Line x1="12" y1="5" x2="1" y2="16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
				<Line x1="12" y1="27" x2="1" y2="16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
			</Svg>
		</Pressable>
	);
}
